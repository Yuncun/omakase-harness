...
echo "omakase: status needs the omakase binary and none could be resolved or fetched. Install one (brew, or a release tarball from github.com/Yuncun/omakase-harness/releases), or set OMAKASE_BIN=/path/to/omakase, then re-run." >&2
exit 1

...
# A leaked GIT_DIR/GIT_WORK_TREE/GIT_COMMON_DIR (exported for ANOTHER repo) would resolve that
# repo instead, find no ledger, and exit 0 — fail OPEN. Resolve from cwd only.

...
[ -f "$GEN/skills/init/SKILL.md" ] && pass "verb skills present (front door)" || fail "no skills/init/SKILL.md"
[ ! -e "$GEN/commands" ] && pass "no legacy commands/ in generic bundle" || fail "unexpected commands/ in bundle"

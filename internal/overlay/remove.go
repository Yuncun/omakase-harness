...
// install — any entry at all. A bare dir is NOT evidence: reading it as the
// pre-0.10 sentinel would send remove into the payload-enumeration fallback,
// deleting untracked files that merely share payload names.
